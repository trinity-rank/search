...
if (class_exists(RouteLang::class)) {
    RouteLang::multilanguage('search/{searchFor}', [SearchController::class, 'searchAjax'])->name('search');
...
// Regular routes
    ...
    Route::get('search/{searchFor}', [SearchController::class, 'searchAjax'])->name('search');
